...
1. Heuristic \\
This is the most simple way, but it is actually a very effective way. And there are some very famous heuristic such as common neighbors, Katz similarity, Preferentail Attachment, ... etc.  We will discuss this method from chapter 5 to chapter 6. \\
2. Latent Feature Method \\


3. Subgraph Sampling Method \\
To illustrate the idea of subgraph sampling, let us draw an example in Figure X. 
