...
To figure out why zero predictions problem happen, we read thr source code of one of famous matrix factorization package "libMF". We find that the 
...
\section{Conclusion}
In this report, we reimplement several models aims at dealing with link prediction problem and apply these models into several data sets. And we actually find some interesting finding that I want to summarize in this section.
