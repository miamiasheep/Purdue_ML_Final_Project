...
In this report, we focus on solving link prediction problem. We should extract features for each link or we cannot use machine learning model to solve the problem. We survey three most common methods in our proposal which is heuristic method, latent feature method and subgraph sampling method.
...
Link Prediction is a problem that 
...
\\
\\
All of our result can be reproduced by following the instruction of README.
