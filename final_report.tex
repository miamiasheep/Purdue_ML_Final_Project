...
\\
However, Matrix Factorization performs bad not because it is not suitable for this problem. Matrix Factorization performs bad because it predicts many zeros. Apparently, there are something going wrong. Table \ref{tab:zero} shows the percentage of zero prdictions of each data set. 
\\
\begin{table}
	\begin{center}
...
\begin{table}
	\begin{center}
		\begin{tabular}{|c|c|c|c|}
			...
			\hline
			Celegans&0.7516&0.7893&5.02\\
			facebook&0.9798&0.9776&-0.22\\
			NS&0.7921&0.9181&15.91\\
			PB&0.8655&0.8358&-3.43\\
			Power&0.5287&0.6411&21.26\\
			Router&0.7236&0.7972&10.17\\
			USAir&0.8153&0.8091&-0.76\\
			Yeast&0.9177&0.9443&2.9\\
			\hline
		\end{tabular}
	\end{center}
	\caption{zero predictions in each data set}
